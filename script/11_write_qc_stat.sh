...
ninds=$(cat $datadir/$original_bfile_name.fam | wc -l)

ninds_m=$(awk '$5==1{print}' $datadir/$original_bfile_name.fam | wc -l)
ninds_f=$(awk '$5==2{print}' $datadir/$original_bfile_name.fam | wc -l)

ninds_con=$(awk '$6==1{print}' $datadir/$original_bfile_name.fam | wc -l)
ninds_case=$(awk '$6==2{print}' $datadir/$original_bfile_name.fam | wc -l)

nsnps=$(cat $datadir/$original_bfile_name.bim | wc -l)
